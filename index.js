...
app.get('/', (request, response) => {
	...
	response.json({ info: `MagicIntelligence API v1.0.29 (env:${process.env.ENV}) MULTISUC`})
});

app.listen(port, () => {
	console.log(`App corriendo en el puerto ${port} v1.0.29 - hotfix (env:${process.env.ENV})`);
});
